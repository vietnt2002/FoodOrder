...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="/admin/thong-ke" class="navbar-brand mx-4 mb-3">
        ...
        <div class="navbar-nav w-100">
            <a href="/admin/thong-ke" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Thống kê</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Quản lý món ăn</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="/admin/quan-ly-mon-an" class="dropdown-item">Món ăn</a>
