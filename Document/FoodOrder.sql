...
SELECT * FROM dbo.GioHang WHERE IdBan = '70E5F20D-2080-435C-B3DB-FBECFCC54CF9'
SELECT * FROM dbo.MonAn
...
SELECT SUM(SoLuong) FROM dbo.GioHang WHERE IdBan = '70E5F20D-2080-435C-B3DB-FBECFCC54CF9'
